...
if ($revi==NULL or $revi=='%')
{
		...
		echo "Klik <a href='replymq.php?id_jud=$id_jud&urutan_rep=$urutan_rep'>ini</a> untuk kembali ke menu New Post<br><br>";
		echo "<meta http-equiv='refresh' content='3;URL=replymq.php?id_jud=$id_jud&urutan_rep=$urutan_rep'></center></div>";
}
else
{
		$no = mysql_query
