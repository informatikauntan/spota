...
if (($revi==NULL or $revi=='%') and (empty($lokasi_file)))
{
		...
		echo "Klik <a href='replyq.php?id_jud=$id_jud&id_rev=$id_rev&urutan_rep=$urutan_rep'>ini</a> untuk kembali ke menu Edit Post<br><br>";
		echo "<meta http-equiv='refresh' content='3;URL=replyq.php?id_jud=$id_jud&id_rev=$id_rev&urutan_rep=$urutan_rep'></center></div>";
}
...
else if (($revi != NULL or $revi != '%') and (empty($lokasi_file)))
{
				...
				echo "Klik <a href='hasilrev1.php?id_jud=$id_jud#$no'>ini</a> untuk kembali ke menu Review Praoutlinet<br><br>";
				echo "<meta http-equiv='refresh' content='3;URL=hasilrev1.php?id_jud=$id_jud#$_POST[ter]'></center></div>";	
}
...
if ($tipe_file == "audio/mpeg")
		...
		if ($ukuran_file > $max_file or $ukuran_file == 0)	
			...
			if (move_uploaded_file($lokasi_file,$direktori))
				...
				<div id='warning'>
				<center><h1>New POST berhasil dikirim</h1><br>";
				echo "Klik <a href='hasilrev1.php?id_jud=$id_jud#$no'>ini</a> untuk kembali ke menu Review Praoutline<br><br>";
				echo "<meta http-equiv='refresh' content='3;URL=hasilrev1.php?id_jud=$id_jud#$_POST[ter]'></center></div>";	
				}	
			}
		}
