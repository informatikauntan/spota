...
$cek=mysql_query("SELECT id_rev_mhs, NIM, status FROM review_mhs WHERE id_rev_mhs='$_GET[id_rev]'");
$hadang=mysql_fetch_array($cek);
if (($hadang['NIM']!=$initid) or ($hadang['status']=="0"))
{
	echo "<div id='warning'>
	<center>
	<h1>GATAL JUGA tuh tangan pengen ubah-ubah URL</h1>
	<br>Klik <a href='reviewmhs2.php?key=$key&field=$field&urutan=$urutan&id_jud=$_GET[id_jud]&halaman=$halaman'>ini</a> untuk kembali ke Desain Praoutline";
}
else
{
