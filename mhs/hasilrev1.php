...
if ($cek['NIM']!=$initid)
{  
echo "<div id='warning'><center><h1>Gatal JUGA tuh tangan pengen ubah-ubah URL</h1><br>Klik <a href='hasilrev1.php?id_jud=$cek[id]'>ini</a> untuk kembali ke Desain Praoutline";
}
else
{		
$id_jud=$_GET['id_jud'];
...
from upload_mhs, review_praoutline where id=id_upload and id='$id_jud' GROUP by id";
$execsql=mysql_query($sql);
$result=mysql_fetch_array($execsql);
?>
<br>
<div id="link">
<a href="hasilrev.php">.:: Kembali ke Halaman Desain Praoutline ::.</a>
</div>
<br>
<div id="judul">
<?php
...
$a = ($result['status_review']=='0'? "" : "|&nbsp;<a href='reply.php?id_jud=$id_jud'><img src='images/newp.gif'></a>");
echo "
...
echo "<table width='100%' align='center'>
  <tr>
	...
	if ($result['status_review']=="1")
	{
		...
		//{
		$navigasi = "
		<a href='replyq.php?id_jud=$id_jud&id_rev=$row[id_review]&urutan_rep=$no'><img src='images/quote.gif'>&nbsp;
		<a href='privatem.php?id_jud=$id_jud&reviewer=$row[reviewer]&urutan_rep=$no'><img src='images/pm.gif'>&nbsp;";
		//}
		//else
		/*{
		$navigasi = "
		<a href='replyq.php?id_jud=$id_jud&id_rev=$row[id_review]&urutan_rep=$no'><img src='images/quote.gif'>&nbsp;
		<a href='edita.php?id_jud=$id_jud&id_rev=$row[id_review]&urutan_rep=$no'><img src='images/edit.gif'></a>&nbsp;
		<a href='privatem.php?id_jud=$id_jud&reviewer=$row[reviewer]&urutan_rep=$no'><img src='images/pm.gif'>&nbsp;";
		}*/
	}
	else
...
if ($rowa['status_review']=="1")
	{
		...
		//{
		$navigasi = "
		<a href='replym.php?id_jud=$id_jud&urutan_rep=$in'><img src='images/reply.gif'></a>&nbsp;
		<a href='replymq.php?id_jud=$id_jud&id_rev=$rowa[id_rev_mhs]&urutan_rep=$in'><img src='images/quote.gif'>&nbsp;
		<a href='privatem.php?id_jud=$id_jud&reviewer=$rowa[rev]&urutan_rep=$in'><img src='images/pm.gif'>&nbsp;";
		/*}
		else
		{
		$navigasi = "
		<a href='replym.php?id_jud=$id_jud&urutan_rep=$in'><img src='images/reply.gif'></a>&nbsp;
		<a href='replymq.php?id_jud=$id_jud&id_rev=$rowa[id_rev_mhs]&urutan_rep=$in'><img src='images/quote.gif'>&nbsp;
		<a href='editam.php?id_jud=$id_jud&id_rev=$rowa[id_rev_mhs]&urutan_rep=$in'><img src='images/edit.gif'></a>&nbsp;
		<a href='privatem.php?id_jud=$id_jud&reviewer=$rowa[rev]&urutan_rep=$in'><img src='images/pm.gif'>&nbsp;";
		}*/
	}
	else
