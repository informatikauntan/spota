...
<br>
<div id="link">
<a href="reviewmhs1.php?field=<?php echo $field;?>&semester=<?php echo $semester;?>&tahun=<?php echo $tahun;?>&halaman=<?php echo $halaman;?>#<?php echo $urutan;?>">.:: Kembali ke Halaman Desain Praoutline ::.</a>
</div>
<br>
<div id="judul">
<?php
...
$a = ($result['status_review']=='0'? "" : "| <a href='replymcari.php?key=$key&field=$field&urutan=$urutan&id_jud=$id_jud&halaman=$halaman'><img src='images/reply.gif'></a>");
