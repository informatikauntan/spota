...
if ($revi==NULL or $revi=='%')
{
		...
		echo "Klik <a href='replymcari.php?key=$key&field=$field&urutan=$urutan&id_jud=$id_jud&halaman=$halaman&urutan_rep=$urutan_rep'>ini</a> untuk kembali ke menu Edit Post<br><br>";
		echo "<meta http-equiv='refresh' content='3;URL=replymcari.php?key=$key&field=$field&urutan=$urutan&id_jud=$id_jud&halaman=$halaman&urutan_rep=$urutan_rep''></center></div>";
}
else
{
		$no = mysql_query
		...
		echo "
		<div id='warning'>
		<center><h1>New Post berhasil</h1><br>Review Anda akan ditampilkan dalam waktu beberapa hari<br>";
