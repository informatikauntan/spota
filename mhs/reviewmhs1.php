...
if ($key == NULL or $key == '%')
{
 if ($semester=="" and $tahun=="")
  {	
  echo "<center><h1>Kata kunci kosong</h1> Kembali ke <a href='reviewmhs.php'>Menu Pencarian</a></center>";
  }
  else
  {
	if ($semester==NULL and $tahun!=NULL)
		...
		$query_hitung = "SELECT id,
				...
				$file = "reviewmhs2a.php?field=$field&semester=$semester&tahun=$tahun";
				if ($jum == 0)
				{
				echo "<center><h1>Tidak terdapat record</h1> Kembali ke <a href='reviewmhs.php'>Menu Pencarian</a></center>";
				}
				else
				{
			...
			echo "<br><br>";
			echo "&nbsp;&nbsp;&nbsp;SPOTA Forums Copyright Teknik Informatika 2009 (Versi 1.1)&nbsp;&nbsp;&nbsp;<a href='reviewmhs.php'>Pencarian</a>"; 
  			}
...
else
{
	...
	LEFT JOIN review_praoutline on upload_mhs.id=review_praoutline.id_upload 
	LEFT JOIN rekap on upload_mhs.id=rekap.id_judul
	GROUP by id HAVING N<>'$initid' and ";
    ...
    $jum = mysql_num_rows($result);
    $jmlhal = ceil($jum/$batas);
    $file = "reviewmhs2.php?key=$key&field=$field";
    if ($jum == 0)
    {
    echo "<center><h1>Tidak terdapat record</h1> Kembali ke <a href='reviewmhs.php'>Menu Pencarian</a></center>";
    }
