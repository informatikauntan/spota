...
<a name="post"></a>
<div id="link">
<a href="praoutline1.php?key=<?php echo $key;?>&field=<?php echo $field;?>&halaman=<?php echo $halaman;?>#<?php echo $urutan;?>">.:: Kembali ke Hasil Pencarian ::.</a>
</div>
<br>
<div id="judul">
<?php
...
echo "
<img src='images/topic.gif'>&nbsp;&nbsp;<b>$result[judul_praoutline]</b>&nbsp;<a href='$link'><img src='images/pdf.gif'></a> :: Klik kanan Save As jika ingin download ::<br>
Oleh : <b>$result[NIM]</b> | Tanggal : $tanggal | Waktu : $result[wkt]<br>Review : $result[P] | Komentar : $result[Q] | Putusan : $result[R] ( Tidak Setuju : $result[S] -- Setuju : $result[T] ) | Status : $sta";
echo "<br><br>";
...
echo "<table width='100%' align='center'>
  <tr>
    <td width='20%' style='background-color:$color1;'><img src='images/user.gif'>&nbsp;$title</td>
	<td width='80%' align='right' style='background-color:$color1;'>";
...
echo "<table width='100%' align='center'>
  <tr>
    <td width='20%' style='background-color:$statusm;'><img src='images/mhs.gif'>&nbsp;Mahasiswa</td>
	<td width='80%' align='right' style='background-color:$statusm;'>
