...
//{
	$navigasi =
/*	"
	<a href='ubahstatus.php?semester=$semester&tahun=$tahun&urutan=$urutan&id_jud=$id_jud&halaman=$halaman&id_rev=$rowa[id_rev_mhs]&urutan_rep=$in&status=$rowa[status]' onclick=\"return confirm('Apakah Anda ingin menampilkan review mahasiswa ini?')\"><img src='images/izin.gif'></a>&nbsp;
	<a href='editrevmhs.php?semester=$semester&tahun=$tahun&urutan=$urutan&id_jud=$id_jud&halaman=$halaman&id_rev=$rowa[id_rev_mhs]&urutan_rep=$in'><img src='images/edit.gif'></a>&nbsp;
	<a href='deleterevmhs.php?semester=$semester&tahun=$tahun&urutan=$urutan&id_jud=$id_jud&halaman=$halaman&id_rev=$rowa[id_rev_mhs]&urutan_rep=$in' onclick=\"return confirm('Apakah Anda benar-benar akan menghapus review ini?')\"><img src='images/delete.gif'></a>&nbsp;
	<a href='privatem.php?semester=$semester&tahun=$tahun&urutan=$urutan&id_jud=$id_jud&halaman=$halaman&reviewer=$rowa[rev]&id_rev=$rowa[id_rev_mhs]&kode=Mahasiswa&urutan_rep=$in'><img src='images/pm.gif'>&nbsp;
