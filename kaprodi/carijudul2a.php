...
<br>
<div id="link">
<a href="carijudul1.php?field=<?php echo $field;?>&semester=<?php echo $semester;?>&tahun=<?php echo $tahun;?>&halaman=<?php echo $halaman;?>#<?php echo $urutan;?>">.:: Kembali ke Halaman Desain Praoutline ::.</a>
</div>
<br>
<div id="judul">
<?php
