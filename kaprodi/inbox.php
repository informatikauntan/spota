...
$sql = mysql_query("SELECT * FROM pesan_pribadi_mini WHERE penerima='$_SESSION[kapro]' ORDER BY status_pesan='0' DESC LIMIT $posisi, $batas");
$no=$posisi;
...
echo "&nbsp;<a href='inbox.php?halaman=$halaman'><img src='images/closem.gif'></a></td>
</tr></table>
<input type='hidden' name='hal' value='$halaman'>
</form><br>";


$sql2=mysql_query("SELECT COUNT(penerima) as 'jum' FROM pesan_pribadi_mini WHERE penerima='$_SESSION[kapro]'");
