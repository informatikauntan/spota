...
if ($has == NULL or $has == '%')
{
	echo "
		...
		echo "Klik <a href='privatewa.php?mode=$mode&id_jud=$id_jud&reviewer=$init&urutan_rep=$urutan_rep'>ini</a> untuk kembali ke menu Private Message<br><br>";
		echo "<meta http-equiv='refresh' content='3;URL=privatewa.php?mode=$mode&id_jud=$id_jud&reviewer=$init&urutan_rep=$urutan_rep'></center></div>";
}
else
{
	if ($aktif=="ad")
	{
		if ($pen=="" or $rec=="")
		...
		else
			{
				...
				echo "Klik <a href='recent1.php?mode=$mode&id_jud=$id_jud#$urutan_rep'>ini</a> untuk kembali ke List Desain Praoutline<br><br>";
				echo "<meta http-equiv='refresh' content='3;URL=recent1.php?mode=$mode&id_jud=$id_jud#$urutan_rep'></center></div>";								
				}
			}
	}
	else
