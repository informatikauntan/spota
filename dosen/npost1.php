...
if (($revi == NULL or $revi == '%') and (empty($lokasi_file)))
{
	echo "
		...
		echo "Klik <a href='recent1.php?mode=$mode&id_jud=$id_jud#bottom'>ini</a> untuk kembali ke menu Review Praoutline<br><br>";
		echo "<meta http-equiv='refresh' content='3;URL=recent1.php?mode=$mode&id_jud=$id_jud#bottom'></center></div>";	
}
...
else if (($revi != NULL or $revi != '%') and (empty($lokasi_file)))
{
	/*if ($jenis_rev=="")
	{
		...
		echo "Klik <a href='npost.php?mode=$mode&id_jud=$id_jud'>ini</a> untuk kembali ke menu Edit Post<br><br>";
		echo "<meta http-equiv='refresh' content='3;URL=npost.php?mode=$mode&id_jud=$id_jud'></center></div>";
	}
	else*/ 
	if ($jenis_rev=="1")
	{
