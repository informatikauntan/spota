...
if (($revi == NULL or $revi == '%') and (empty($lokasi_file)))
{
	if ($revsoh==NULL)
	{
		...
		echo "Klik <a href='warned.php?mode=$mode&id_jud=$id_jud&id_rev=$id_rev&urutan_rep=$urutan_rep'>ini</a> untuk kembali ke menu Edit Post<br><br>";
		echo "<meta http-equiv='refresh' content='3;URL=warned.php?mode=$mode&id_jud=$id_jud&id_rev=$id_rev&urutan_rep=$urutan_rep'></center></div>";
	}
	else
	{
		if ($del=="1")
