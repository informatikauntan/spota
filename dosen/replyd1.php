...
else if (($revi != NULL or $revi != '%') and (empty($lokasi_file)))
{
	/*if ($jenis_rev=="")
	{
		...
		echo "Klik <a href='replyd.php?key=$key&field=$field&urutan=$urutan&id_jud=$id_jud&halaman=$halaman'>ini</a> untuk kembali ke menu Edit Post<br><br>";
		echo "<meta http-equiv='refresh' content='3;URL=replyd.php?key=$key&field=$field&urutan=$urutan&id_jud=$id_jud&halaman=$halaman'></center></div>";
	}*/
	//else 
